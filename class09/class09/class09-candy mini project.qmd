...
0 represents not containing chocalate whereas 1 represents containing chocolate candy.
...
ggsave("barplot3.png", width = 6, height = 10)
```
![My third figure](barplot3.png)
...
Fruity, Pluribus and hard are all picked up strongly positively in PC1. Yes this makes sense, we saw this in the PCA score plot as well.
